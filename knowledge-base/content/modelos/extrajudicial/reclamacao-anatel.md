---
type: Modelo
title: "Reclamação — Anatel"
description: "Modelo de reclamação para a Anatel."
tags: [modelo, reclamacao, anatel, telecom]
...
modelo:
  ...
  campos:
    ...
    - {nome: numero_linha, rotulo: "Número da linha, do contrato ou do cliente na operadora", obrigatorio: true}
...
Modelo de reclamação para a Anatel. A Anatel regula telefonia, internet e TV por assinatura.

## Quando usar

Para serviço de telecomunicações, depois de reclamar na própria operadora. A Anatel pede o número do protocolo do atendimento na operadora.
...
**Linha, contrato ou código do cliente:** {{numero_linha}}
